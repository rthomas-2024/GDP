...
def Combined_DiffyQ(t, u):
    ...
    print(t)
    print(sol_rT.t)
    # PLACEHOLDER, WRITE A FUNCTION THAT RETURNS THE NEXT TIME STEPS rT WITHIN THIS DIFFYQ, AS THE NEXT TIMESTEP'S rT IS NEEDED TO CORRECTLY TRANSFORM THE f_LVLH, ITS KEPLERIAN MOTION SO SHOULD BE "EASY" TO SOLVE (f AND g FUNCTIONS MAYBE?!)
...
t = int(2.5*tau); # time for to dock
...
ax1.scatter(0, 0, 0,s=100, marker='.', c='k', label='origin')
#ax1.plot(r_LVLH_C[0], r_LVLH_C[1], r_LVLH_C[2], c='b', label="unpetervbed")
ax1.plot(r_LVLHCOMB_C[0], r_LVLHCOMB_C[1], r_LVLHCOMB_C[2], c='g', label="from LVLH" )
#ax1.plot(r_COMBCONV_C[0], r_COMBCONV_C[1], r_COMBCONV_C[2], c='r', label="from ECI")
...
plotTraj(r_ECICOMB_T[0], r_ECICOMB_T[1], r_ECICOMB_T[2], "target", "r", ax2, Marker=True)
plotTraj(r_ECICOMB_C[0], r_ECICOMB_C[1], r_ECICOMB_C[2], "chaser from ECI", "g", ax2, Marker=True)
plotTraj(r_COMBCONV_C[0], r_COMBCONV_C[1], r_COMBCONV_C[2], "chaser from LVLH", "b", ax2, Marker=True)

ax2.set_xlim3d(0.99*r_COMBCONV_C[0][-1], 1.01*r_COMBCONV_C[0][-1])
ax2.set_ylim3d(0.99*r_COMBCONV_C[1][-1], 1.01*r_COMBCONV_C[1][-1])
ax2.set_zlim3d(0.99*r_COMBCONV_C[2][-1], 1.01*r_COMBCONV_C[2][-1])
...
fig.suptitle('LVLH velocites', y=0.95, fontsize=20)

ax1.set_title('x_dot')
ax1.plot(t_LVLH, v_LVLHCOMB_C[0])
ax1.set_xlabel("time, sec")
ax1.set_ylabel("xdot, m/sec")
ax1.grid()

ax2.set_title('y_dot')
ax2.plot(t_LVLH, v_LVLHCOMB_C[1])
ax2.set_xlabel("time, sec")
ax2.set_ylabel("ydot, m/sec")
ax2.grid()

ax3.set_title('z_dot')
ax3.plot(t_LVLH, v_LVLHCOMB_C[2])
ax3.set_xlabel("time, sec")
ax3.set_ylabel("zdot, m/sec")
ax3.grid()
