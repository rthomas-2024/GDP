...
def Orbital_DiffyQ(t, u):#, mu):
    ...
    if J2_BOOL == True:
        ...
        a_j2 = (1.5*J2*mu*(R**2)/(rmag**4)) * np.array([tx,ty,tz]) # orbital mechanics for engineering students, 4th edition. this was verified against example 10.2 in this textbook
        a = a + a_j2
...
r_error =  np.array([sol_ECI_T.y[0], sol_ECI_T.y[1], sol_ECI_T.y[2]])
v_error = np.array([sol_ECI_T.y[0], sol_ECI_T.y[1], sol_ECI_T.y[2]])
